...
class Dialog(QTabWidget, gui.Ui_TabWidget):     #self er Dialog
    ...
    def calcLoans(self):
        ...
        print(lanUtreikn(loan1Funds, g_payment, 12, loan1Interest, loan1Indexed))
        ...
        print(lanUtreikn(loan2Funds, g_payment, 12, loan2Interest, loan2Indexed))
        ...
        print(lanUtreikn(loan3Funds, g_payment, 12, loan3Interest, loan3Indexed))
...
def main():                   
    ...
    app.exec_()
    '''
    a=raw_input('Innistaeda (double): ')
    b=raw_input('timi i fjolda manada(int): ')
    c=raw_input('vextir i prosentu(double): ')
    d=raw_input('Verdtrygging(bool): ')
    print(onePayment(0,1000,12,3.00,False))
    a = raw_input()
    '''
main()
